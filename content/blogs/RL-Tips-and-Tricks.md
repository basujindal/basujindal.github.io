...
summary: 
description: "Reinforcement Learning can do wonders but selecting the best algorithm and then tuning it's hyper-parameters is not an easy task. This blog post aims at making the process easier by listing out a few general suggestions and a list of hyper-parameters to tune for each algorithm.
"
cover:
  image:
  alt:
...
- These two links have a good collection of tuned hyperparams: [link 1](https://github.com/ray-project/ray/tree/master/rllib/tuned_examples){:target="\_blank"},
  [link 2](https://github.com/araffin/rl-baselines-zoo/tree/master/hyperparams){:target="\_blank"}
